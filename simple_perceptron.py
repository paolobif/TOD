...
class BinaryPerceptron:
    ...
    def classify(self, x_vector):
        ...
        x_vector = self.activation(x_vector)
    ...
    def train_with_one_example(self, x_vector, y, weight = 1):
        """
        ...
        #Otherwise, update
            ...
            self.weights = np.add(self.weights, weight*y*self.alpha*self.activation(x_vector))
            return True
